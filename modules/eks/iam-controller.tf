...
# data "aws_iam_policy" "load_balancer_controller_policy" {
#   count = var.create_eks_cluster ? 1 : 0
...
#   policy_arn = data.aws_iam_policy.load_balancer_controller_policy[0].arn
# }
...
resource "aws_iam_policy" "aws_load_balancer_controller" {
  ...
  name   = "AWSLoadBalancerController-test"
}
